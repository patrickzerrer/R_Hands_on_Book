...
In der Kommunikationswissenschaft, beziehungsweise in den Sozialwissenschaften allgemein, bezieht sich der Begriff "latente Variable" auf eine *nicht direkt beobachtbare Eigenschaft* oder einen *nicht direkt messbaren Faktor*, der sich jedoch durch meistens mehrere beobachtbaren oder messbare Variablen (teilweise auch als Indikatoren bezeichnet) manifestiert. Latente Variablen sind theoretische Konstrukte, die nicht direkt gemessen werden können. Als Wissenschaftler:innen nehmen wir allerdings an, dass diese Konstrukte existieren, um bestimmte Phänomene oder Eigenschaften besser erklären zu können.
...
Die *Indexbildung* umfasst drei relevante Schritte: (1) Zunächst muss ein theoretisches Konstrukt entwickelt werden. In unserem Fall würde das bedeuten, dass wir ein theoretisches Verständnis von *Vertrauen in gesellschaftliche Institutionen* entwickeln und uns klar werden was wir darunter verstehen. (2) Im nächsten Schritt müssten wir dann schauen, ob sich dieses theoretische Konstrukt in Form einer latenten Variable auch in unseren Daten finden lässt, hierfür werden wir eine Faktorenanalyse durchführen. (3) Als letzten Schritt führen wir die eigentliche Indexbidlung durch. Hier berechnen wir eine neue Variable - den Index für *Vertrauen in gesellschaftliche Institutionen* und Überprüfen dessen Güte.

In der Sozialwissenschaft dienen latente Variablen dazu, theoretische Modelle zu erstellen und Hypothesen zu testen. Sie helfen uns Forscher:innen dabei, versteckte Zusammenhänge und Muster zu erkennen, die durch das Betrachten der beobachteten Indikatoren nicht zwangsläufig direkt erkennbar sind. Hierbei müssen wir allerdings darauf achten, dass wir passende statistsiche Methoden verwenden, um die Zuverlässigkeit und Belastbarkeit der Ergebnisse sicher stellen zu können.
...
2. Des Weiteren möchten wir unser Verständnis von *Vertrauen in gesellschaftliche Institutionen* empirisch anhand der Daten überprüfen, um zu schauen, ob eine latente Variable messbar ist.
