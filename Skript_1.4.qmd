...
Wir nutzen in diesem Kurs `pacman`, um etwas einfacher die von uns benötigten Pakete zu laden. Mit der Funktion `p_load` könnt ihr die von euch in der Klammer angegebenen Pakete laden und damit für die aktuelle Session aktivieren.
...
Alternativ könnt ihr mit dem `library` Befehl einzelne Pakete laden.
