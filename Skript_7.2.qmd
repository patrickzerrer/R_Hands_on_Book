...
![Grafik: Kann das Alter die Fernsehnutzung erklären? (Picture generated by midjourney)](Bilder/young_and_old_people_watching_tv._graphic_novel_st_3133b55d-6544-4463-9571-14d5367d6533.png)
...
## Beispiel: Vorhersage des Modells für die tägliche Internetnutzung in Minuten bei Alter von 25 und 75
```{r}
...
## Beispiel 2: Vorhersage des Modells für die tägliche Internetnutzung in Minuten bei Alter von 20, 30, 40, 50, 60 und 70
```{r}
