...
ggplot(daten, aes(x = Konfession, fill = sex)) +
  ...
  scale_fill_manual(values = c("darkgreen", "papayawhip", "tan4")) 
...
daten_neu$Einkommensgruppe <- haven::as_factor(daten_neu$Einkommensgruppe)
daten_neu$sex <- haven::as_factor(daten$sex)
